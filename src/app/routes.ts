...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "dao/:id/governance", lazy: lazy(() => import("./components/pages/DAOGovernancePage"), "DAOGovernancePage") },
      { path: "dao/:id/proposals/new", lazy: lazy(() => import("./components/pages/DAONewProposalPage"), "DAONewProposalPage") },
      { path: "dao/:id/proposals/:proposalId", lazy: lazy(() => import("./components/pages/ProposalDetailPage"), "ProposalDetailPage") },
      ...
      { path: "workspace/tasks/:id", lazy: lazy(() => import("./components/pages/WorkspaceTaskDetailPage"), "WorkspaceTaskDetailPage") },
