import svgPaths from "./svg-0djr9ya0r1";
...
function Heading3() {
  return (
    <div className="h-[27.999px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-semibold leading-[28px] left-[572.85px] not-italic text-[#364153] text-[20px] text-center top-[-0.24px] tracking-[-0.4492px] whitespace-nowrap">纯图标版</p>
    </div>
  );
}
